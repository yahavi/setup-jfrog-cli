...
class Utils {
    static downloadCli() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (version.toLowerCase() === 'latest') {
                return yield this.downloadLatestCli(fileName);
            }
    ...
    static downloadLatestCli(fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            let url = Utils.getCliUrl('[RELEASE]', fileName);
            let cliDir = yield toolCache.downloadTool(url);
            let cliPath = path.join(cliDir, fileName);
            if (!Utils.isWindows()) {
                fs.chmodSync(cliPath, 0o555);
            }
